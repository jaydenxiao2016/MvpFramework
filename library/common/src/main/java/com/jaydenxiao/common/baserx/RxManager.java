...
public class RxManager {
    ...
    public void clear() {
        ...
        for (Map.Entry<String, Observable<?>> entry : mObservables.entrySet()) {
            ...
            mRxBus.removeStickyEvent(entry.getKey());// 移除rxbus stikey观察
        }
    }
    ...
    //发送rxbus stikey
    public void postStikey(Object tag, Object content) {
        if(content==null){
            throw  new IllegalArgumentException("postStikey的content不允许为null");
        }else{
