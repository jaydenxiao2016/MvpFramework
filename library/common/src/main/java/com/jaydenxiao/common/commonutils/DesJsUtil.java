 ...
 * 加密工具
 */
public class DesJsUtil {

	private static String[] keys = { "www", "cryjs", "com" };
	...
	public static String encode(String enStr) {
		return strEnc(enStr, keys[0], keys[1], keys[2]);
	 ...
	 * @return
	 */
	public static String decode(String deStr) {
		return strDec(deStr, keys[0], keys[1], keys[2]);
	}

	@SuppressWarnings("rawtypes")
	private static String strEnc(String data, String firstKey, String secondKey,
								 String thirdKey) {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	private static String strDec(String data, String firstKey,
