...
public class ViewHolderHelper extends RecyclerView.ViewHolder {
    ...
    public ViewHolderHelper setInVisible(int viewId, boolean visible) {
        View view = getView(viewId);
    ...
    public ViewHolderHelper setOncheckListener(int viewId, CompoundButton.OnCheckedChangeListener listener){
        CompoundButton check =getView(viewId);
