...
public class ImgSelConfig {
    ...
    public static class Builder implements Serializable {
        ...
        public Builder(ImageLoader loader,String Path) {
            this.loader = loader;

            if (FileUtils.isSdCardAvailable())
                filePath = Environment.getExternalStorageDirectory().getAbsolutePath() + Path;
            else
                filePath = Environment.getRootDirectory().getAbsolutePath() + Path;
