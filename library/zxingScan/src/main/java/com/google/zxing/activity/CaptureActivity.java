...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, OnClickListener {
    ...
    private static final int PARSE_BARCODE_NO_CODE = 250;
    ...
    public final static String SCAN_TYPES = "SCAN_TYPES";
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case PARSE_BARCODE_SUC: // 解析图片成功
                    ...
                    break;
                case PARSE_BARCODE_NO_CODE:
                    Toast.makeText(activityReference.get(), "该图片没找到二维码或条形码",
    ...
    public static void startAction(Activity activity, int RequestCode) {
        Intent intent = intent = new Intent(activity, CaptureActivity.class);
